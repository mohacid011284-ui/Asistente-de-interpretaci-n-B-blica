...
# --- PROMPT ---
INSTRUCCIONES = """ACTÚA COMO: Instructor de Seminario. MODO AULA: Socrático. MODO REVISIÓN: Crítico."""
def get_prompt():
    t = INSTRUCCIONES
...
with st.sidebar:
    st.title("Panel")
    archivo = st.file_uploader("Subir", type=["pdf","txt","md"])
...
with c4: 
    if st.button("🔍 Revisión"): click("Modo Revisión")
